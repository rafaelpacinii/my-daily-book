...
CREATE TABLE `__new_editions` (
	...
	`cover_source` text DEFAULT 'remote' NOT NULL,
...
SELECT
  ...
  "metadata_source",
  CASE
    WHEN "metadata_source" = 'manual' THEN NULL
    ELSE "external_metadata_id"
  END,
  "google_books_id",
  "google_books_etag",
  "title",
  ...
  "small_thumbnail_url",
  CASE
    WHEN "cover_url" IS NULL OR trim("cover_url") = '' THEN 'none'
    ELSE 'remote'
  END,
  NULL,
  NULL,
